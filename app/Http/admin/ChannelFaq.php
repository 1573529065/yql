...
use App\Dal\ChannelFaq as ChannelFaqDal;
...
class ChannelFaq extends BaseController
{
    ...
    public function index()
    {
        ...
        $list = ChannelFaqDal::fetchList($where, $offset, $pagesize, 'id DESC');
        $total = ChannelFaqDal::count($where);
    ...
    public function edit()
    {
        if ($this->request->isPost()) {
            ...
            ChannelFaqDal::update(['id' => $data['id']], $data);
            Helper::json(true);
        }
        ...
        $info = ChannelFaqDal::fetchOne(['id' => $id]);
    ...
    public function delete()
    {
        ...
        ChannelFaqDal::update(['id' => $id], ['status' => -1]);
        Helper::json(true);
    }
    ...
    public function toggle()
    {
        ...
        ChannelFaqDal::update(['id' => $id], [$field => $val]);
        Helper::json(true);
    }
