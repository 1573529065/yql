...
use App\Dal\CoinExpenseDaily as CoinExpenseDailyDal;
use App\Dal\User;
use App\Service\Helper;
use App\Service\Pagination;

class CoinExpenseDaily extends BaseController
{
    ...
    public function index()
    {
        ...
        $list = CoinExpenseDailyDal::fetchList($where, $offset, $pagasize, 'id DESC');
        $total = CoinExpenseDailyDal::count($where);
